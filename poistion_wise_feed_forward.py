...
class PositionWiseFeedFoward(object): #TODO make it parallel
    ...
    def position_wise_feed_forward_fn(self):
        ...
        ouput_conv1=tf.nn.conv2d(input,filter1,strides=[1,1,1,1],padding="VALID",name="conv1",data_format='NHWC') #[batch,sequence_length,1,1]
        ...
        output_conv2=tf.nn.conv2d(ouput_conv1,filter2,strides=[1,1,1,1],padding="VALID",name="conv2",data_format='NHWC') #[batch,sequence_length,1,d_model]
